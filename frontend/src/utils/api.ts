...
export const get = async <T>(url: string, params = {}, token = ''): Promise<T> => {
  try {
...
export const post = async <T>(url: string, data: unknown, token = ''): Promise<T> => {
  try {
...
export const put = async <T>(url: string, data: unknown, token = ''): Promise<T> => {
  try {
